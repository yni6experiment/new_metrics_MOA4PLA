...
public class SmallerFintnessValuesWindow extends javax.swing.JFrame {
  ...
  public SmallerFintnessValuesWindow() {
    ...
    //addYni
    GuiUtils.makeTableNotEditable(tableSvcBest);
    //addYni
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        //addYni
        panelSvcBest = new javax.swing.JPanel();
        ...
        //addYni
        tableSvcBest = new javax.swing.JTable();
        //addYni
        ...
        panelSvcBest.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        panelSvcBest.setMinimumSize(new java.awt.Dimension(250, 50));

        jLabel30.setFont(new java.awt.Font("Lucida Grande", 1, 13)); // NOI18N
        jLabel30.setText("Svc");

        tableSvcBest.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tableSvcBest.setMinimumSize(new java.awt.Dimension(300, 64));
        tableSvcBest.setName("svc");
        tableSvcBest.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableSvcBestMouseClicked(evt);
            }
        });
        jScrollPane40.setViewportView(tableSvcBest);

        org.jdesktop.layout.GroupLayout panelSvcBestLayout = new org.jdesktop.layout.GroupLayout(panelSvcBest);
        panelSvcBest.setLayout(panelSvcBestLayout);
        panelSvcBestLayout.setHorizontalGroup(
        		panelSvcBestLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(org.jdesktop.layout.GroupLayout.TRAILING, panelSvcBestLayout.createSequentialGroup()
                .addContainerGap()
                .add(panelSvcBestLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    .add(jScrollPane40)
                    .add(panelSvcBestLayout.createSequentialGroup()
                        .add(0, 372, Short.MAX_VALUE)
                        .add(jLabel30)))
                .addContainerGap())
        );
        panelSvcBestLayout.setVerticalGroup(
        		panelSvcBestLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(panelSvcBestLayout.createSequentialGroup()
                .add(jLabel30)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jScrollPane40, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 94, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(0, 17, Short.MAX_VALUE))
        );
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                //addYni
                	.add(panelSvcBest, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                //addYni
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    //addYni
                    	.add(18, 18, 18)
                    	.add(panelSvcBest, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    //addYni
  ...
  private void tableConventionalBestMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableConventionalBestMouseClicked
    ...
    tableFeatureDrivenBest.clearSelection();
    tablePLAExtBest.clearSelection();
    tableSvcBest.clearSelection();//addYni
  ...
  private void tableSvcBestMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablePLAExtBestMouseClicked
	    updateTableObjectives(evt);
	    tableEleganceBest.clearSelection();
	    tableFeatureDrivenBest.clearSelection();
	    tableConventionalBest.clearSelection();
  ...
  public static void main(String args[]) {
    ...
    //addYni
    private javax.swing.JPanel panelSvcBest;
    //addYni
    ...
    //addYni
    private javax.swing.JTable tableSvcBest;
    //addYni
  ...
  public void enablePanelsObjectiveFunctions() {
    ...
    for (int i = 0; i < metricsSelectedForCurrentExperiment.length; i++) {
      ...
      //addYni
      if (f.equalsIgnoreCase("svc")) {
          initializeContentForSvcTable();
          panelSvcBest.setVisible(true);
        }
  ...
  private void initializeContentForSvcTable() {
	    BestSolutionBySelectedFitness.buildTable(tableSvcBest,
	            BestSolutionBySelectedFitness.calculateBestSvc(selectedExperiment));
	  }
